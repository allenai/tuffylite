...
public class SampleAlgorithm_BruteForceEnumerate extends MRFSampleAlgorithm{

	int lengthOfBitMap = -1;
	Enumerator enumerator = null;
	
	public SampleAlgorithm_BruteForceEnumerate(LinkedHashMap<String, Object> property, ArrayList<Integer> sampleDomain) {
	...
	public void init(MRF _mrf) {
		...
		enumerator = new Enumerator(sampleDomain.size());
